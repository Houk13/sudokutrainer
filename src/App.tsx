...
function App() {
  ...
  return (
    <div className="App">
      ...
      <PuzzleArea update={update(updateSelection, newSelection)} data={data} puzzleType="quickScanSudoku" puzzle={puzzle} puzzleGenerator={generateQuickScan} selected={selection}/>
    </div>
